            ...
            <ModalBody>
                <div className="px-5 pt-5">
                    ...
                    <p className="mb-4">
                        ...
                        <a href="https://twitter.com/RPSGameClub" title="RPSGameClub Twitter" className="twitter-icon me-2" target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-2x fa-twitter"></i>
                        </a>                       
                        <a href="https://discord.gg/Ygk58VR4" title="RPS Discord" className="discord-icon" target="_blank" rel="noopener noreferrer">
