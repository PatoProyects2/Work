...
const LocalWalletProfile = ({ playerDocument, isMobileResolution }) => {
  const xpClassText = () => {
  ...
  return (
    <div className="profile-container">
      <h3 className="TitleUsuario my-3 text-center">
        {playerDocument.account.substring(0, 5) +
          "..." +
          playerDocument.account.substring(38, 42) +
          " Stats"}
      </h3>
          ...
          <div className="profile-stats-container">
            <StyledStats>
              ...
              <span className="text-center text-white">
                {playerDocument.whitelist ? "WHITELISTED" : "NOT WHITELISTED"}
              </span>
            </StyledStats>
          </div>
        )}
...
export default LocalWalletProfile;
