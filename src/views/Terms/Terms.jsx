            ...
            <div className='row pt-5'>
                <div className='col-sm-10 col-12 mx-auto my-auto'>
                    ...
                    <p className='lead pt-3'>
                        These terms of service are entered into by and between You and our platform. ("Company",
                        "we" or "us"). The following terms of service, (collectively, these "ToS"), govern your access
                        to and use of the Website www.rpsgames.club ("Website"), including any content,
                        functionality and services offered on or through the Website, whether as a guest or a
                        registered user. You acknowledge and agree with our terms and conditions with and without
                        reservatio.
                    </p>
                    <p className='lead'>
                        These ToS come into force as soon as You access the Website, by doing which You signify
                        to www.rpsgames.club that You have read these ToS and accept them. By using any page of
                        the Websites You signify that You agree entirely with these ToS and our Privacy Policy. If you
                        do not want to agree to these ToS or the Privacy Policy, you must not access or use the
                        Website.
                    </p>
                    <p className='lead'>
                    ...
                    <ul className='lead'>
                        ...
                        <li>You are solely responsible for reporting and accounting for any taxes applicable to You
                    ...
                    <ul className='lead pb-3'>
                        ...
                        <li>Evidence that an offer is being claimed or benefits the same person or group of persons,
                            ...
                            generated from that offer will be canceled/confiscated</li>
                        <li>Equal, zero or low margin bets</li>
                        <li>Wagering bonuses on excluded games</li>
                        <li>Co-operation, collusion or organization of bets from the same source</li>
                        <li>Manipulation of software, exploitation of loopholes or other technical forms of abuse or other
                            behavior which amounts to deliberate cheating</li>
                        <li>Masking IP address or using a VPN</li>
                    </ul>
                    ...
                    <ul className='lead'>
                        <li>
                            ...
                            a contest or promotion sponsored by us, and when you report a problem with our Website.
                        ...
                        <li>
                            ...
                            others at your own risk. Additionally, we cannot control the actions of other users of the
                    ...
                    <p className='lead pt-3'>
                        ...
                        lost winnings, however we will do our due diligence in determining the best outcome for both
                        parties. <br />
                    ...
                    <ul className='lead'>
                        ...
                        <li>shall not be liable for any loss, costs, expenses or damages, whether direct, indirect, special,
                            consequential, incidental or otherwise, arising in relation to Your use of the Websites or Your
                            participation in the Games, however we will do our due diligence in determining the best
                            outcome for both parties.</li>
                    </ul>
                    <p className='lead pb-3'>
                        You hereby agree to fully indemnify and hold harmless rpsgames.club, its directors,
                        employees, partners, and service providers for any cost, expense, loss, damages, claims
                        and liabilities howsoever caused that may arise in relation to Your use of the Website or
                        participation in the Games.
                    </p>
                    <h4 className="mt-3"><i className="fa-solid fa-hashtag"></i>&nbsp; 5. Responsible gaming</h4>
                    <p className='lead py-3'>
                        On request, we will close any account for a minimum period of 6 months during which time it
                        will not be possible for the account to be reopened for any reason.
                        You can close your account under our responsible gaming self-exclusion policy at anytime
                        by contacting our Customer Support team by emailing <a className="content-link" href="mailto:support@rpsgames.club">support@rpsgames.club</a>
                        Upon expiry of the self-exclusion period you may request to reopen a closed account by
                        contacting our Customer Support team.
                    </p>
                    <h4 className="mt-3"><i className="fa-solid fa-hashtag"></i>&nbsp; 6. Entire Agreement</h4>
                    <p className='lead py-3'>
                        The Terms of service and our Privacy Policy constitute the sole and entire agreement
                        between you and the Company with respect to the Website and supersede all prior and
                    ...
                    <h4 className="mt-3"><i className="fa-solid fa-hashtag"></i>&nbsp; 7. Changes to the Terms of service</h4>
                    <p className='lead py-3'>
                        ...
                        these ToS, the English version shall prevail. Your continued use of the Website following the
                        posting of revised Terms of service means that you accept and agree to the changes. You
